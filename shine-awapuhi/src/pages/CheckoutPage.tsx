        ...
        return (
            <div className="min-h-screen bg-warm-50 flex items-center justify-center p-4 font-sans text-gray-900 relative overflow-hidden">
                ...
                <motion.div
                    ...
                    className="max-w-md w-full bg-white rounded-[2.5rem] p-12 text-center shadow-warm-lg border border-primary/5 relative z-10"
                    dir={dir}
                >
            ...
            <div className="container mx-auto max-w-6xl relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <motion.div
                        ...
                        className="lg:col-span-7 bg-white/95 backdrop-blur-sm rounded-[2.5rem] p-5 lg:p-10 shadow-warm-lg border-2 border-primary/10"
                        dir={dir}
                    >
                        <h1 className="text-3xl lg:text-4xl font-bold text-primary mb-1 text-center lg:text-right font-cairo">
                            {t.title}
                        </h1>
                        <p className="text-gray-500 mb-6 text-center lg:text-right font-cairo">
                            {t.subtitle}
                        </p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="fixed bottom-0 left-0 w-full p-4 bg-white/90 backdrop-blur-md border-t border-primary/10 z-50 shadow-warm-lg lg:relative lg:p-0 lg:bg-transparent lg:border-t-0 lg:shadow-none lg:pt-4">
                                <Button
                                    type="submit"
                                    size="lg"
                                    className="w-full py-6 text-xl shadow-warm-lg hover:shadow-primary/20 uppercase font-bold disabled:opacity-70 disabled:cursor-not-allowed rounded-full gradient-cta text-white transition-all hover:scale-[1.02] active:scale-[0.98]"
                                    disabled={isSubmitting}
                                >
                                    {isSubmitting ? (language === 'ar' ? 'جاري الطلب...' : 'Traitement...') : t.form.submit}
                                </Button>
                                <p className="text-center text-gray-500 text-sm mt-3 lg:mt-4 italic font-cairo font-bold">
                                    {t.form.cod}
                                </p>
                            </div>
                        </form>
                    ...
                    >
                        <div className="bg-primary text-white rounded-[2.5rem] p-5 lg:p-8 shadow-warm-lg">
                            ...
                            <div className="space-y-4 mb-6">
                                {[
                                    { img: shampooImg, name: "شامبو Shine Awapuhi", label: "Maui Moisture Shine + Glow" },
                                    { img: maskImg, name: "ماسك Shine Awapuhi", label: "Maui Moisture Shine + Glow" },
