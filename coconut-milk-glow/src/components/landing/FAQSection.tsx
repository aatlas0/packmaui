...
const faqs = [
  {
    ...
    answer: "هذا الباك مصمم خصيصاً للشعر الجاف والتالف والمتقصف. يمكن استخدامه على الشعر المجعد، المموج، أو المفرود.",
  },
  {
    question: "كم مرة يجب استخدام الماسك أسبوعياً؟",
    answer: "ننصح باستخدام الماسك 2-3 مرات أسبوعياً للحصول على أفضل النتائج. يمكن زيادة الاستخدام في حالة الشعر شديد الجفاف.",
  },
  {
    question: "هل المنتجات خالية من المواد الضارة؟",
    answer: "نعم، جميع منتجات Maui Moisture خالية من السلفات والسيليكون والبارابين. تركيبات طبيعية آمنة على شعرك.",
  },
  {
          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                ...
                <svg
                  className={`w-5 h-5 text-primary flex-shrink-0 mr-4 transition-transform duration-200 ${
