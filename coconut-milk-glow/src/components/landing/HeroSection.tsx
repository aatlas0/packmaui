        ...
        <div className="container mx-auto relative z-10 px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-center text-center lg:items-start lg:text-right animate-fade-up">
              ...
              {/* Main Headline */}
              <h1 className="text-5xl sm:text-6xl lg:text-[5rem] font-bold text-foreground leading-[1.3] lg:leading-[1.4] mb-8 drop-shadow-md font-cairo">
                باك جوز الهند
                <span className="block mt-1 mb-1 text-transparent bg-clip-text bg-gradient-to-l from-golden to-amber-200 drop-shadow-sm">
                  لتغذية وترطيب
                </span>
                الشعر الجاف
              </h1>
              ...
              {/* Paragraph */}
              <p className="text-lg sm:text-xl lg:text-2xl text-foreground/80 mb-10 leading-relaxed max-w-2xl font-medium font-cairo mix-blend-plus-lighter">
                روتين متكامل بحليب جوز الهند وزبدة المانجو لشعر ناعم، لامع، وصحي من أول استعمال
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto mb-12">
                ...
                >
                  ...
                  <span className="relative z-10 text-center">اطلب الآن – <span className="text-xl">449</span> درهم</span>
                </Link>
                <a
                  href="#products"
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 text-sm font-bold text-foreground/90 font-cairo">
                {['نتائج من أول استعمال', 'خالي من السيليكون', 'خالي من السلفات'].map((feature, idx) => (
            ...
            <div className="lg:col-span-5 relative flex justify-center items-center mt-12 lg:mt-0 animate-fade-in w-full">
              ...
              <div className="relative z-20 animate-float w-full flex justify-center">
                <img src={heroBundle}
                  ...
                  className="w-full sm:w-[80%] lg:w-[120%] lg:max-w-none xl:w-[110%] object-contain rounded-[2.5rem] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] lg:-ml-12" fetchPriority="high" />
              </div>
            </div>
