...
const faqs = [
  {
    ...
    answer: "هذا الباك مصمم خصيصاً للشعر المصبوغ والجاف. يعمل على حماية اللون من البهتان مع توفير ترطيب مكثف بفضل معادن البحر.",
  },
  {
  ...
  },
  {
    ...
    answer: "نعم، جميع منتجات Maui Moisture خالية من المنظفات الكبريتية (Sulfated Surfactants) والسيليكون والبارابين. تركيبات طبيعية آمنة تماماً على شعرك المصبوغ.",
  },
  {
