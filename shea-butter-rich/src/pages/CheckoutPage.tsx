...
const CheckoutPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-warm-50 pt-8 pb-32 lg:py-16 px-4 font-sans text-gray-900 relative">
                    ...
                    >
                        <div className="bg-primary text-white rounded-[2.5rem] p-5 lg:p-8 shadow-warm-lg">
                            ...
                            <div className="space-y-4 mb-6">
                                {[
                                    { img: shampooImg, name: "شامبو Shea Butter", label: "Maui Moisture Heal & Hydrate" },
                                    { img: maskImg, name: "ماسك Shea Butter", label: "Maui Moisture Heal & Hydrate" },
