...
const faqs = [
  {
    ...
    answer: "هذا الباك مصمم خصيصاً للشعر الجاف جداً والتالف. يعمل على توفير ترطيب مكثف وإصلاح الألياف بفضل زبدة الشيا وزيت المكاديميا.",
  },
  {
    question: "كم مرة يجب استخدام الماسك أسبوعياً؟",
    answer: "ننصح باستخدام الماسك 2-3 مرات أسبوعياً. للحالات شديدة الجفاف، يمكن تركه لفترة أطول للحصول على تغذية أعمق.",
  },
  {
    question: "هل المنتجات خالية من المواد الضارة؟",
    answer: "نعم، جميع منتجات Maui Moisture خالية من المنظفات الكبريتية (Sulfated Surfactants) والسيليكون والبارابين. تركيبة غنية وطبيعية آمنة تماماً.",
  },
  {
